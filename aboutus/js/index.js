var render = function() {
    ...
    $('#community_title').after(function() {
        return Mustache.render($(this).html(), data.content);
    });
    $('#content_body').after(function() {
        return Mustache.render($(this).html(), data.content);
    });
    $('#content_img').after(function() {
        return Mustache.render($(this).html(), data.content);
    });
    $(".nav ul li:eq(0)").removeClass('curr')
